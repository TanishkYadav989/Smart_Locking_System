...
void DISPLAY_OFF(){
	uint8_t off[2]={0x80,0xAE}; //*Buffer with Control Byte & Display off command*//
	I2C_Start(0x3C,2,off); //*Sending the Display off command to turn-off the OLED when entering STOP-Mode*//
}